...
.EXAMPLE
   .\New-AzureWebsitewithDB.ps1 -WebSiteName "myWebSiteName" -Location "West US" `
        -StorageAccountName "myStorageAccountName" -ClientIPAddress "131.107.159.226"
#>
param(
...
$appDBConnStrInfo = @{ Name = $AppDatabaseName; Type = "SQLAzure"; ConnectionString = $appDBConnStr };
